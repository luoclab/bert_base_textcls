...
if __name__ == '__main__':
    model_path = 'checkpoint/model_v2.0_np_250220_128_40_le5_11.pth'#np==not parallel
    train_flag = True
    if train_flag:
        trainpath = 'data/train/devide_V2.0_0.1_11/train'
    ...
    #     result_file = 'result/result_250207_1.txt'
    #     testpath = 'data/test/train_V1.0_test'
    #     # testpath = './train_data_231207/test'
    ...
    # train_test = False
    # if train_test:
    #     model_path = './model/model_v1.0_240117_1_64_30_le5_345_3.pth'
    #     trainpath = './train_data_240110/train_V1.0_all'
    #     print(trainpath, model_path)
    #     sentences_all, labels_all, filenames_all = get_data_v1_0(trainpath)        
        
    #     split_idx = int(len(sentences_all) / 10)
    #     sentences_test, labels_test, filename_test, sentences_train, labels_train, filename_train \
    #         = sentences_all[0:split_idx], labels_all[0:split_idx], filenames_all[0:split_idx], sentences_all[split_idx:], labels_all[split_idx:], filenames_all[split_idx:]
    #     print(len(sentences_test), len(sentences_train), len(sentences_all))
    #     train(sentences_train, labels_train, model_path)
    #     result_file = './result/result_240117_1.txt'
    #     test(sentences_test, labels_test, model_path, result_file, filename_test)    
