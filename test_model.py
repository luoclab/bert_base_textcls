...
def test(sentences_test, labels_test, model_path, result_file, filenames,DataParallel):
    ...
    with torch.no_grad():
        ...
        # label2idx12 = {'党政公文': 0, '合同文档': 1, '简历': 2, '教程指南': 3, '论文文献': 4, '总结汇报': 6, 
        #      '其他类别': 5, '财务报告': 7, '试卷与习题': 8, '毕设论文': 9}
        # idx2label1 = {v: k for k, v in label2idx12.items()}  # 反向映射

        # # 计算混淆矩阵
        cm = confusion_matrix(labels_test, label_pres)

        # # 获取类别名称（按索引排序）
        # labels = [idx2label1[i] for i in sorted(idx2label1.keys())]
        ...
        plt.savefig("result/model_v2.0_np_250220_128_40_le5_11.png")
        plt.show()
...
if __name__ == '__main__':
    model_path = 'checkpoint/model_v2.0_np_250220_128_40_le5_11.pth'
    result_file = 'result/model_v2.0_np_250220_128_40_le5_11.txt'
    # os.ma
    testpath = 'data/train/devide_V2.0_0.1_11/test'
    DataParallel = False
